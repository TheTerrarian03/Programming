...
my_countries = ["Unites States", "Russia", "Ukraine", "World", "Germany", "Egypt", "Japan"]
...
for c in unique_countries:
  if c in my_countries:
    ...
    plt.plot(years, sum_elec, label=c, marker=markers[my_countries.index(c)])
