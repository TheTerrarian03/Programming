...
def main():
    ...
    pygame.display.set_caption("Unit Converter - Option 2: Temperature Converter")
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                # GO!
                    ...
                    if (len(b1Contents) and len(b2Contents) and len(b3Contents)) >= 1:
                        answer.clear()
                        if b1Contents == ['f', 'a', 'h', 'r', 'e', 'n', 'h', 'e', 'i', 't']:
                            b1Contents = ["f"]
                        if b2Contents == ['k', 'e', 'l', 'v', 'i', 'n']:
                            b2Contents = ["k"]
                        if b3Contents == ['c', 'e', 'l', 'c', 'i', 'u', 's']:
                            b3Contents = ["c"]
                        a = processors.option2(b1Contents, b2Contents, b3Contents)
                        for char in str(a):
                            answer.append(char)
                # HELP! 's
