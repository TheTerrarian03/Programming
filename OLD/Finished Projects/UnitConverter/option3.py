...
def main():
    ...
    pygame.display.set_caption("Unit Converter - Option 3: Time Converter")

    clock = pygame.time.Clock()
    fps = 30

    bg = pygame.image.load("option3.png")
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                # GO!
                    ...
                    if (len(b1Contents) and len(b2Contents) and len(b3Contents)) >= 1:
                        answer.clear()
                        if b1Contents == ['m', 'i', 'l', 'l', 'i', 's', 'e', 'c', 'o', 'n', 'd', 's']:
                            b1Contents = ["m", "s"]
                        if b1Contents == ['s', 'e', 'c', 'o', 'n', 'd', 's']:
                            b1Contents = ["s"]
                        if b1Contents == ['m', 'i', 'n', 'u', 't', 'e', 's']:
                            b1Contents = ["m"]
                        if b1Contents == ['h', 'o', 'u', 'r', 's']:
                            b1Contents = ["h"]
                        if b1Contents == ['d', 'a', 'y', 's']:
                            b1Contents = ["d"]
                        if b1Contents == ['w', 'e', 'e', 'k', 's']:
                            b1Contents = ["w"]
                        if b1Contents == ['y', 'e', 'a', 'r', 's']:
                            b1Contents = ["y"]
                        if b1Contents == ['d', 'e', 'c', 'a', 'd', 'e', 's']:
                            b1Contents = ["dec."]
                        if b1Contents == ['c', 'e', 'n', 't', 'u', 'r', 'i', 'e', 's']:
                            b1Contents = ["cent."]
                        if b3Contents == ['m', 'i', 'l', 'l', 'i', 's', 'e', 'c', 'o', 'n', 'd', 's']:
                            b3Contents = ["m", "s"]
                        if b3Contents == ['s', 'e', 'c', 'o', 'n', 'd', 's']:
                            b3Contents = ["s"]
                        if b3Contents == ['m', 'i', 'n', 'u', 't', 'e', 's']:
                            b3Contents = ["m"]
                        if b3Contents == ['h', 'o', 'u', 'r', 's']:
                            b3Contents = ["h"]
                        if b3Contents == ['d', 'a', 'y', 's']:
                            b3Contents = ["d"]
                        if b3Contents == ['w', 'e', 'e', 'k', 's']:
                            b3Contents = ["w"]
                        if b3Contents == ['y', 'e', 'a', 'r', 's']:
                            b3Contents = ["y"]
                        if b3Contents == ['d', 'e', 'c', 'a', 'd', 'e', 's']:
                            b3Contents = ['d', 'e', 'c', '.']
                        if b3Contents == ['c', 'e', 'n', 't', 'u', 'r', 'i', 'e', 's']:
                            b3Contents = ['c', 'e', 'n', 't', '.']
                        a = processors.option3(b1Contents, b2Contents, b3Contents)
                        for char in str(a):
                            answer.append(char)
                # HELP! 's
