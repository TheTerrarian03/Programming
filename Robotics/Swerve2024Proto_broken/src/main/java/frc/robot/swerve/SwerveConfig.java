...
public final class SwerveConfig {
    ...
    public static final class FLMod0 {
        ...
        public static final double angleOffsetC = 52.6;  // 52.2070;
        public static final double angleOffsetP = 14.39;  // unused?
    ...
    public static final class FRMod1 {
        ...
        public static final double angleOffsetC = 300.6;  // 300.6738;
    ...
    public static final class BLMod2 {
        ...
        public static final double angleOffsetC = 198.8;  // 288.5449;
    ...
    public static final class BRMod3 {
        ...
        public static final double angleOffsetC = 232.1;  // 331.2597;  // 323.380254;
